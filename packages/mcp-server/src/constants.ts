...
export const ACCESS_TOKEN_TTL_SEC = 2700; // 45 min
export const PRIVY_TOKEN_STORE_TTL_SEC = 7200; // 2h Redis ceiling; actual expiry checked via JWT exp
export const PRIVY_TOKEN_EXP_BUFFER_SEC = 300; // 5-min safety margin before Privy token expiry
export const MAX_STORED_PRIVY_TOKENS = 10_000;
...
export const TRANSPORT_REVOCATION_GRACE_SEC = 10;
