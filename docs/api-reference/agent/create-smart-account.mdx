...
<CardGroup cols={2}>
  <Card title="Activate Agent" href="/api-reference/agent/activate">
    Activate the agent after user deposits
  </Card>
  <Card title="Get Smart Account" href="/api-reference/agent/get-smart-account">
  ...
  <Card title="Complete Workflow" href="/guides/complete-workflow">
