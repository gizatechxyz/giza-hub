...
<Card title="Agent Module API" icon="robot" href="/api-reference/agent/create-smart-account">
...
<Card title="Optimizer Module API" icon="chart-mixed" href="/api-reference/optimizer/optimize">
...
<CardGroup cols={3}>
  <Card
    title="Agent Module"
    icon="robot"
    href="/api-reference/agent/create-smart-account"
  >
