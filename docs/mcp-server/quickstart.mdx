...
<Tip>
`GIZA_CHAIN_ID` defaults to Base (`8453`). Change it to target a different chain.
</Tip>
...
| `GIZA_CHAIN_ID` | No | -- | Chain ID (e.g., `8453` for Base) |
