...
The MCP server supports three configuration tiers. Use the simplest one that fits your needs.
...
| `tools` | `ToolDefinition[]` | All 23 tools | Which tools to register. Import groups from the package. |
