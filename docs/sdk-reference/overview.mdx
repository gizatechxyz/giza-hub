...
The `@giza/agent-sdk` is a TypeScript SDK that provides a simple and type-safe interface for interacting with Giza's autonomous DeFi yield optimization agents.
