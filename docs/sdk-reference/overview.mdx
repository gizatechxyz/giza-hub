...
The `@gizatech/agent-sdk` is a TypeScript SDK that provides a resource-oriented, type-safe interface for managing Giza autonomous DeFi yield optimization agents. It handles authentication, request retries, pagination, and error handling so you can focus on building your integration.
